...
<body id="page-top">
    ...
    <div id="main_tabs">
        <div class="container">
            <div class="tabs">
                <div class="row">
                    <div class="col-lg-4">
                        <button class="btn btn-xl active tab_buttons" id="profile_button" onclick="student">Students</button>
                    </div>
                    <div class="col-lg-4">
                        <button class="btn btn-xl tab_buttons" id="companies_button" onclick="company">Companies</button>
                    </div>
                    <div class="col-lg-4">
                        <button class="btn btn-xl tab_buttons" id="offered_button" onclick="offered">Offered</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var btn1 = document.getElementById("student"),
            btn2 = document.getElementById("company"),
        ...
        function companies(){
            ...
            btn3.classList.remove("active");
            btn4.classList.remove("active");
            document.getElementById("studen").classList.add("section-inactive");
